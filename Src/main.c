...
int main(void)
{
  ...
  /* USER CODE END RTOS_THREADS */
	...
	BSP_LCD_FillRect(0,0,250,480);
	
	BSP_LCD_SetTextColor(LCD_COLOR_RED);
	BSP_LCD_FillRect(251,0,299,480);
	
	BSP_LCD_SetTextColor(LCD_COLOR_BLUE);
	BSP_LCD_FillRect(551,0,249,480);
	
	BSP_LCD_SetTextColor(LCD_COLOR_WHITE);
	BSP_LCD_SetFont(&eng48);
	BSP_LCD_DisplayStringAt(80, 240, (uint8_t*)"LEFT", LEFT_MODE, 0);
	BSP_LCD_DisplayStringAt(351, 240, (uint8_t*)"STOP", LEFT_MODE, 0);
	BSP_LCD_DisplayStringAt(630, 240, (uint8_t*)"RIGHT", LEFT_MODE, 0);
